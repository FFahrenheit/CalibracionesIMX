...
@Component({
  selector: 'app-attach-resources',
  templateUrl: './attach-resources.component.html',
  styleUrls: ['./attach-resources.component.scss']
})
export class AttachResourcesComponent implements OnInit {
